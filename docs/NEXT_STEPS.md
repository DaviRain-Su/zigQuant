...
- **v0.6**: 混合计算模式 (借鉴 Freqtrade: 向量化回测 + 增量实盘) ← 当前焦点
...
**主题**: 混合计算模式 + 实盘交易集成
**核心目标**: 实现向量化回测与增量实盘统一 (借鉴 Freqtrade)
...
### v0.5.0 核心组件
- ✅ MessageBus (Pub/Sub, Request/Response, Command)
- ✅ Cache (Quote, Candle, Order, Position)
- ✅ DataEngine (IDataProvider 接口)
- ✅ ExecutionEngine (IExecutionClient 接口)
- ✅ LiveTradingEngine (统一交易接口)

### 待实现功能
- ⏳ 向量化回测 (v0.6.0)
- ⏳ 实盘交易适配器 (v0.6.0)
- ⏳ Paper Trading (v0.6.0)
- ⏳ 做市优化 (v0.7.0)
- ⏳ 风险管理 (v0.8.0)
- ⏳ Web 界面 (v1.0.0)
...
### v0.6.0 完成标准
- [ ] 向量化回测引擎实现
- [ ] HyperliquidDataProvider 实现
- [ ] HyperliquidExecutionClient 实现
- [ ] Paper Trading 模式
- [ ] `zigquant run-strategy --paper` 命令
- [ ] 完整文档
- [ ] 零内存泄漏
- [ ] 550+ 单元测试通过
