...
| 指标 | 全称 | 类型 | 描述 | 状态 |
|------|------|------|------|------|
| **SMA** | Simple Moving Average | 趋势 | 简单移动平均 | ✅ v0.3.0 |
| **EMA** | Exponential Moving Average | 趋势 | 指数移动平均 | ✅ v0.3.0 |
| **RSI** | Relative Strength Index | 动量 | 相对强弱指标 | ✅ v0.3.0 |
| **MACD** | Moving Average Convergence Divergence | 趋势+动量 | 移动平均收敛散度 | ✅ v0.3.0 |
| **BB** | Bollinger Bands | 波动率 | 布林带 | ✅ v0.3.0 |
